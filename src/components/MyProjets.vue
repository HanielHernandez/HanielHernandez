...
const projects = [
  {
    ...
    imageUrL: '../src/assets/img/customizable_css.PNG',
  ...
  },
  {
    ...
    imageUrL: '../src/assets/img/firechat.PNG',
...
.pill {
  @apply bg-neutral-400 p-2 px-4 mr-2 inline-block text-white dark:bg-neutral-600;
