...
<template>
  <div>
    <div class="flex flex-col md:flex-row">
      ...
      <div class="flex flex-col ritems-center w-full md:w-3/5 p-4 lg:p-0">
        ...
        <p
          ...
          :key="`${index}-pagraph`"
          class="dark:text-gray-400 text-justify text-gray-600 mb-2 text-md font-regular description"
          v-html="$t(paragraph)"
        ></p>
      </div>
    </div>
